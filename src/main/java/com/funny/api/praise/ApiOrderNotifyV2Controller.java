 ...
 */
@RestController
@RequestMapping("/api/praise/order/v2")
@ConditionalOnProperty("optional.youzan.enable")
public class ApiOrderNotifyV2Controller {

    private static final Logger logger = LoggerFactory.getLogger(ApiOrderNotifyV2Controller.class);
